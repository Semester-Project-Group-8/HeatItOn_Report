% --- Add to preamble ---
% \usepackage{xcolor}
% \definecolor{nounred}{HTML}{8B0000} % Dark red for nouns
% \definecolor{verbblue}{HTML}{00008B} % Dark blue for verbs
% -----------------------
...
\begin{multicols}{3} % This splits the list into 3 columns
\begin{itemize}
    \item Asset Manager
    \item Data
    \item Files
